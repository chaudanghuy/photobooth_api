...
ALLOWED_HOSTS = ['139.180.209.110', '127.0.0.1', 'localhost','172.30.1.16','127.0.0.1','124.216.166.162','3.26.21.10','photobooth-api-c2ku.onrender.com']
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # nơi collectstatic sẽ copy file vào
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # nơi bạn lưu CSS/JS gốc
]
